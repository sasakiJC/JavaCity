 ...
 * $Id$
 */
package metaphor.types.util;

import metaphor.types.*;
 ...
 * <!-- end-user-doc -->
 * 
 * @see metaphor.types.TypesPackage
 * @generated
 */
public class TypesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case TypesPackage.VISUAL_ENTITY: {
			VisualEntity visualEntity = (VisualEntity) theEObject;
			T result = caseVisualEntity(visualEntity);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TypesPackage.ENTITY2_D: {
			Entity2D entity2D = (Entity2D) theEObject;
			T result = caseEntity2D(entity2D);
			if (result == null)
				result = caseVisualEntity(entity2D);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TypesPackage.ENTITY3_D: {
			Entity3D entity3D = (Entity3D) theEObject;
			T result = caseEntity3D(entity3D);
			if (result == null)
				result = caseEntity2D(entity3D);
			if (result == null)
				result = caseVisualEntity(entity3D);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
