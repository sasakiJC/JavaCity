 ...
 * @generated
 */
public class StaticsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StaticsPackage.RELATION: {
				Relation relation = (Relation)theEObject;
				T result = caseRelation(relation);
				if (result == null) result = caseCodeElement(relation);
				if (result == null) result = caseVisualizableElement(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StaticsPackage.SCLASS: {
				SClass sClass = (SClass)theEObject;
				T result = caseSClass(sClass);
				if (result == null) result = caseCodeElement(sClass);
				if (result == null) result = caseVisualizableElement(sClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StaticsPackage.SPACKAGE: {
				SPackage sPackage = (SPackage)theEObject;
				T result = caseSPackage(sPackage);
				if (result == null) result = caseCodeElement(sPackage);
				if (result == null) result = caseVisualizableElement(sPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StaticsPackage.CODE_ELEMENT: {
				...
				if (result == null) result = caseVisualizableElement(codeElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StaticsPackage.SMETHOD: {
				SMethod sMethod = (SMethod)theEObject;
				T result = caseSMethod(sMethod);
				if (result == null) result = caseCodeElement(sMethod);
				if (result == null) result = caseVisualizableElement(sMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseSMethod(SMethod object) {
		return null;
	}
