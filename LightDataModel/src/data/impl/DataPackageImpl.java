...
public class DataPackageImpl extends EPackageImpl implements DataPackage {
	 ...
	 * @generated
	 */
	private EClass visualizableElementEClass = null;
	 ...
	 * @generated
	 */
	public EClass getVisualizableElement() {
		return visualizableElementEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getVisualizableElement_MetaphorObject() {
		return (EAttribute)visualizableElementEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		visualizableElementEClass = createEClass(VISUALIZABLE_ELEMENT);
		createEAttribute(visualizableElementEClass, VISUALIZABLE_ELEMENT__METAPHOR_OBJECT);
	}
	...
	public void initializePackageContents() {
		...
		// Add subpackages
		getESubpackages().add(theStaticsPackage);
		...
		initEClass(visualizableElementEClass, VisualizableElement.class, "VisualizableElement", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVisualizableElement_MetaphorObject(), ecorePackage.getEJavaObject(), "metaphorObject", null, 0, 1, VisualizableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
