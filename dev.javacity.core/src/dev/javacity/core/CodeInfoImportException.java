...
/**
 * 可視化するソースコードの情報を取得できなかったときにスローされる実行時例外です。
 *
 */

public class CodeInfoImportException extends RuntimeException {

	/**
	 * 詳細メッセージなしでCodeInfoImportExceptionを構築します。
	 */
	public CodeInfoImportException() {
		super();
		// TODO 自動生成されたコンストラクター・スタブ
	}

	/**
	 * 詳細メッセージを持つCodeInfoImportExceptionを構築します。
	 * @param message 詳細メッセージ
	 */
	public CodeInfoImportException(String message) {
		super(message);
		// TODO 自動生成されたコンストラクター・スタブ
	}

	/**
	 * 指定された詳細メッセージ及び原因を使用してCodeInfoImportExceptionを構築します。
	 *
	 ...
	 */
	public CodeInfoImportException(String message, Throwable cause) {
		super(message, cause);
		// TODO 自動生成されたコンストラクター・スタブ
	}
	 ...
	 * @param cause 原因(あとで{@link Throwable#getCause()}メソッドで取得できるように保存される)。(<tt>null</tt>値が許可されており、原因が存在しないか不明であることを示す。)
	 */
	public CodeInfoImportException(Throwable cause) {
		super(cause);
		// TODO 自動生成されたコンストラクター・スタブ
	}
}
