...
package javacity.visual.metaphor.ambience;
...
public final class Lightning {
	...
	private static final Color3f AMBIENT_COLOR = new Color3f(Color.WHITE);

	/** The diffuse color used in {@link #DEFAULT_MATERIAL}. */
	private static final Color3f DIFFUSE_COLOR = new Color3f(Color.WHITE);

	/** The emissive color used in {@link #DEFAULT_MATERIAL}. */
	private static final Color3f EMISSIVE_COLOR = new Color3f(Color.WHITE);

	/** The spectacular color used in {@link #DEFAULT_MATERIAL}. */
	private static final Color3f SPECTACULAR_COLOR = new Color3f(Color.WHITE);
